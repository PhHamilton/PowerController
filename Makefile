...
OBJ_C = $(wildcard ${DIR_OLED}/*.c ${DIR_CONFIG}/*.c ${DIR_FONTS}/*.c ${DIR_GUI}/*.c  ${DIR_C_JSON}/*.c ${DIR_GUI_H}/*.c ${DIR_ROT}/*.c ${DIR_MENU}/*.c ${DIR_OUTPUT}/*.c ${DIR_CURRENT}/*.c ${DIR_I2C}/*.c ${DIR_MQTT}/*.c) ${TARGET}.c
OBJ_O = $(patsubst %.c,${DIR_BIN}/%.o,$(notdir ${OBJ_C}))

INCLUDES= -I$(DIR_CONFIG) -I$(DIR_OLED) -I$(DIR_FONTS) -I$(DIR_GUI) -I$(DIR_C_JSON) -I$(DIR_GUI_H) -I$(DIR_ROT) -I$(DIR_MENU) -I$(DIR_OUTPUT) -I$(DIR_CURRENT) -I$(DIR_I2C) -I$(DIR_MQTT) -I.
